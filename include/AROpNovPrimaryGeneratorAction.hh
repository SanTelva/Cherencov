...
#ifndef AROpNovPrimaryGeneratorAction_h
...
class AROpNovPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    AROpNovPrimaryGeneratorAction();
    virtual ~AROpNovPrimaryGeneratorAction();
