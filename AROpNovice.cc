...
//  runManager-> SetUserInitialization(new OpNoviceDetectorConstruction());
  runManager-> SetUserInitialization(new AROpNovDetectorConstruction());  
  // Physics list
...
//  runManager-> SetUserInitialization(new AROpNovPrimaryGeneratorAction());
//  runManager-> SetUserInitialization(new AROpNovSteppingAction());
